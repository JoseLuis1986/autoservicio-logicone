...
const columns = [
  ...
  { key: 2, name: "Beneficio", fieldName: "BenefitPlanId", minWidth: 100, maxWidth: 200, isResizable: true },
  { key: 3, name: " ", fieldName: "BenefitOptionId", minWidth: 100, maxWidth: 200, isResizable: true },
  ...
  { key: 6, name: "Monto de deducción", fieldName: "AccountingCurrencyAmount", minWidth: 100, maxWidth: 200, isResizable: true },
  { key: 7, name: "Incluido en factura", fieldName: "TaxCode", minWidth: 100, maxWidth: 200, isResizable: true },
]

export const Contributions = ({ data, loading }) => {
  const dataFiltered = data?.filter((item) => item.IsEmployer === "Yes");
