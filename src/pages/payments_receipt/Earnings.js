...
const columns = [
    { key: 1, name: "Resultados de comprobación del presupuesto", fieldName: "PayStatementNumber", minWidth: 150, maxWidth: 200, isResizable: true },
    { key: 2, name: "Fecha", fieldName: "AccountingDate", minWidth: 150, maxWidth: 200, isResizable: true },
    { key: 3, name: "Codigo de ganancia", fieldName: "EarningCode", minWidth: 150, maxWidth: 200, isResizable: true },
    ...
    { key: 6, name: "Cantidad", fieldName: "Quantity", minWidth: 150, maxWidth: 200, isResizable: true },
    { key: 7, name: "Tarifa", fieldName: "EarningRate", minWidth: 150, maxWidth: 200, isResizable: true },
    { key: 8, name: "Monto", fieldName: "AccountingCurrencyAmount", minWidth: 150, maxWidth: 200, isResizable: true },
