 ...
 */
const columns = [
  { key: 1, name: "Date ", fieldName: "RequestDate", minWidth: 100, maxWidth: 200, isResizable: true },
  { key: 2, name: "Tipo", fieldName: "LeaveTypeId", minWidth: 100, maxWidth: 200, isResizable: true },
  { key: 3, name: "Amount", fieldName: "Amount", minWidth: 100, maxWidth: 200, isResizable: true },
]
